...
Meteor.startup(function () {
    ...
    Push.addListener('token', function(token) {
        ...
        console.log("DEBUG Push event token " + JSON.stringify(token))
    });
    ...
    Push.addListener('register', function(evt) {
        ...
        console.log("DEBUG Push event register " + JSON.stringify(evt))
    });

    Push.addListener('alert', function(notification) {
        // Called when message got a message in forground
        console.log("DEBUG Push event alert " + JSON.stringify(notification))
    });

    Push.addListener('sound', function(notification) {
        // Called when message got a sound
        console.log("DEBUG Push event sound " + JSON.stringify(notification))
    });

    Push.addListener('badge', function(notification) {
        // Called when message got a badge
        console.log("DEBUG Push event badge " + JSON.stringify(notification))
    });

    Push.addListener('startup', function(notification) {
        // Called when message recieved on startup (cold+warm)
        console.log("DEBUG Push event startup " + JSON.stringify(notification))
    });

    Push.addListener('message', function(notification) {
        // Called on every message
        console.log("DEBUG Push event message " + JSON.stringify(notification))
    });

    console.log('DEBUG Added Push Listeners');
