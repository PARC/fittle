...
Questions.create = function (askDate,
    ...
    const values = {
        ...
        [FIELDS.TAG]: tag ? tag : '',
        [FIELDS.TEXT]: text,
        [FIELDS.AFTERWORD]: afterword ? afterword : "",
...
Questions.addQuestion = function (text,
    ...
    if (!Questions.findOne(already_answered_query)) {
        ...
        console.log('INFO Adding Question askDay=' + askDay + ' askDate=' + askDate );
        console.log('INFO Adding Question askDay=' + expireDay + ' askDate=' + expireDate );
