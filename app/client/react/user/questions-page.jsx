                    ...
                    <div className="flex-row-container" id="report-questions-area">
                        ...
                        <div className="flex-item">
                            {parent.singleOk ? undefined :
                                <button type="button" className="btn btn-primary btn-submit coach-submit-button"
...
export default QuestionsPageContainer = createContainer(({userName, holdOff}) => {
    ...
    console.log("\n**********DEBUG 1a participantIsReady " + JSON.stringify(participantIsReady));
    console.log("\n**********DEBUG 1b question ready " + JSON.stringify(questionHandle.ready()));
    const now = new Date().getTime();

    let participant = Participants.findOne();
    console.log("\n**********DEBUG 2 Participant " + JSON.stringify(participant));
    ...
    console.log("\n**********DEBUG 2a timeTravelInDays " + timeTravelInDays);
    console.log("\n**********DEBUG 2b askDatetime " + askDatetime);
    console.log("\n**********DEBUG 2c expireDatetime " + expireDatetime);
