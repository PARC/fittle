...
DEVELOPMENT_SERVER_URL="https://ACTUAL_HOSTNAME_GOES_HERE.meteorapp.com"

# URL of Galaxy production server. Used building for production environment.
PRODUCTION_SERVER_URL="https://ACTUAL_HOSTNAME_GOES_HERE.meteorapp.com"
...
outputFolder="/Users/lnelson/meteor_home/parccoach/build"
