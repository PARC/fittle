...
curl -H "Content-Type: application/json" -X POST -d @./data/json/onboarding.fake.silver.json http://localhost:3000/serviceapi/participants/add/ACTUAL_TOKEN_GOES_HERE
