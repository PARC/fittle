...
meteor build $OUTPUT_PATH --server=https://ACTUAL_HOSTNAME_GOES_HERE.meteorapp.com --mobile-settings=settings.production.json
...
echo "Copy to server"
cp $APK_PATH/app-aligned.apk $APK_PATH/ACTUAL_HOSTNAME_GOES_HERE.apk
cp -f $APK_PATH/ACTUAL_HOSTNAME_GOES_HERE.apk $DEST_PATH/ACTUAL_APK_GOES_HERE.apk
