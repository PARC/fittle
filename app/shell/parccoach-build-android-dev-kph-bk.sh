...
echo "Copy over AltDev KPH settings.json and mobile-config"
...
meteor build $OUTPUT_PATH --server=https://parccoach-dev-kph.meteorapp.com
...
echo "Done building android DEV-KPH"